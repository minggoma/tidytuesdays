...
Given this, I will clean the data below and make two separate data frames. 

The wide data frame will have observations of *agricultural output in one year*. In this wide data frame, it would not make sense for a year to appear multiple times in separate rows - the observation (row) represents the year, of which there is only one. 

The long data frame will have observations of *agricultural output of a specific category*. 
...
plot(wide1$`Total Sheep`, wide1$`Total Beef Cattle`)

#Interestingly, as the number of sheep increase, the number of cattle also increases
