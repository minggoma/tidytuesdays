...
# Arguments:
#   df - a data frame
#   vec - a vector with the column indices of dummy variables
...
dummy01 <- c2[c(1, 3, 4, 9, 10, 11, 14, 15, 16, 17, 19, 20, 21 , 22, 23)]
dummy02 <- bb
dummy03 <- bb
...
bb[, colnames(m)[1]][[1]][outlierindices]
...
with(bb, {
    ...
    for(i in 1:ncol(m)){
        ...
        #Plot a histogram
        hist(bb[, colnames(m)[1]][[1]], main = colnames(m)[i])
